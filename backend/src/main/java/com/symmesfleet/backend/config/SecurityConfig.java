...
import com.symmesfleet.backend.security.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/customer/signup", "/api/customer/login").permitAll()
                        .requestMatchers("/actuator/health").permitAll()
                        .requestMatchers("/api/admin/**").hasAuthority("ROLE_ADMIN")
                        .requestMatchers("/api/bookings/**").hasAuthority("ROLE_CUSTOMER")
                        .requestMatchers("/api/mechanic-requests").hasAuthority("ROLE_CUSTOMER")
