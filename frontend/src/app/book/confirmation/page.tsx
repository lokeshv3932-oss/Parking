...
function ConfirmationContent() {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-20 text-center">
      ...
      {processing && (
        <>
          <h1 className="text-3xl font-black text-white">Payment Processing</h1>
          <p className="mt-4 text-white/70">
      ...
      {!succeeded && !processing && (
        <>
          <h1 className="text-3xl font-black text-white">Payment Not Completed</h1>
          <p className="mt-4 text-white/70">
      ...
      {bookingId && <p className="mt-4 text-sm text-white/40">Reference #{bookingId}</p>}
